...
const I18N = (() => {
  ...
  const STRINGS = {
    tr: {
      ...
      "wheel.assocHint": "İçinde en çok \"cuk oturan\" çağrışımı işaretlemek için üstüne tıkla — o ok renklenecek.",
      ...
      "import.invalid": "Bu dosya geçerli bir rüya kaydı gibi görünmüyor.",
      "import.error": "Dosya okunamadı, tekrar dener misin?",
      "result.mapHeading": "Sembol Haritası",
      "result.mapHint": "Altın çağrışım düğümüne tıkla — 4 soruya verdiğin cevaplar da birer düğüm olarak açılır. Sürükleyerek kaydır, tekerlek/iki parmakla yakınlaştır.",
    ...
    en: {
      ...
      "wheel.assocHint": "Click the association that \"clicks\" the most for you — that arrow will light up.",
      ...
      "import.invalid": "This file doesn't look like a valid dream record.",
      "import.error": "Couldn't read the file, want to try again?",
      "result.mapHeading": "Symbol Map",
      "result.mapHint": "Click the golden association node — your answers to the 4 questions open up as their own nodes. Drag to pan, scroll wheel / pinch to zoom.",
