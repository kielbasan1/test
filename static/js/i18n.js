...
const I18N = (() => {
  ...
  const STRINGS = {
    ...
    en: {
      ...
      "johnson.ritual": "In Johnson's method the next step is ritual: binding the interpretation to life through a concrete, symbolic act — so it is lived, not merely understood. But this app cannot suggest that ritual to you. Only you know what actually carries weight for you; a ritual handed down from outside becomes the very thing the method avoids. Build it yourself, after you've written your interpretation.",
